 ...
 * 単体処理ビュー
 */
public class SingleProcessView_old extends ConstraintLayout {
    ...
    public SingleProcessView_old(Context context) {
        this(context, null);
    }

    public SingleProcessView_old(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SingleProcessView_old(Context context, AttributeSet attrs, int defStyle) {
