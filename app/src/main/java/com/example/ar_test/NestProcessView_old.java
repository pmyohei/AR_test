 ...
 * * ネストあり処理ビュー（ループ／分岐処理）
 */
public class NestProcessView_old extends ConstraintLayout {
    ...
    public NestProcessView_old(Context context) {
        this(context, null);
    }

    public NestProcessView_old(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestProcessView_old(Context context, AttributeSet attrs, int defStyle) {
